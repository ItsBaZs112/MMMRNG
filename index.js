...
var weaponsIcons = [toString(0),toString(1),toString(2),toString(3),toString(4),toString(5),toString(6),toString(7),toString(8),toString(9),toString(10),toString(11),toString(12),toString(13),toString(14),toString(15),toString(16),toString(17),toString(18),toString(19),toString(20),toString(21),toString(22),toString(9999)]
var maxNumbers = 5
...
function rngWeapon() {
    return weaponIcons[Math.floor(Math.random()*weaponIcons.length)];  
}
