...
var weaponsIcons = string(irandom(22))
var maxNumbers = 5
...
function randomizeBase() {
    ...
    w1.src = "res/weapons/"+weaponsIcons+".png"
    w2.src = "res/weapons/"+weaponsIcons+".png"
    w3.src = "res/weapons/"+weaponsIcons+".png"
    w4.src = "res/weapons/"+weaponsIcons+".png"
    w5.src = "res/weapons/"+weaponsIcons+".png"
    w6.src = "res/weapons/"+weaponsIcons+".png"
    w7.src = "res/weapons/"+weaponsIcons+".png"
    w8.src = "res/weapons/"+weaponsIcons+".png"
    w9.src = "res/weapons/"+weaponsIcons+".png"
    w10.src = "res/weapons/"+weaponsIcons+".png"
    w11.src = "res/weapons/"+weaponsIcons+".png"
    w12.src = "res/weapons/"+weaponsIcons+".png"
